...
venue: "Department of Land Air, & Water Resorces, University of California, Davis"        # brief name of host site without address (e.g., "Euphoric State University")
address: "One Shield Avenue, Davis CA 95616"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "38.5382, -121.7617"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "Jul 16-17, 2020"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 am - 4:30 am"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2020-07-16      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate:2020-07-18         # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Mahesh L Maskey, Karen Word, Elizabeth Williams"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Jose Pablo Ortiz Partida, David Serrano"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["mmaskey@ucdavis.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
